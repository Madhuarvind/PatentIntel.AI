...
def test_patent_model(token: str, model_id: str = "madhuaravind21/patentintel-llama3-1m"):
    ...
    try:
        ...
        print("\n1. Dispatching test prompt to Hugging Face Inference API...")
        ...
        with urllib.request.urlopen(req) as response:
            ...
            print("-" * 60)
            print("\n✅ Verification Successful! Model generated structured patent reasoning.")

    except Exception as e:
        print(f"\n⚠️ Benchmark note/notice: {e}")
        print("   If model is still loading into Hugging Face warm cache, wait 1-2 minutes and re-run!")
